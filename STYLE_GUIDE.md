...
--font-heading: PP Formula SemiExtended, PP Formula, ui-sans-serif, system-ui,
  sans-serif;
...
--font-mono: Cinetype Mono, IBM Plex Mono, ui-monospace, SFMono-Regular, Menlo,
...
/* Button padding */
padding: clamp(8px, 4.625px + 0.75vw, 14px) clamp(18px, 15.75px + 0.5vw, 22px);
```
...
.primary-button {
  ...
  border: 0;
  border-radius: 1px;
  background: linear-gradient(to right, #14141c, #14141c), linear-gradient(45deg, #f5c0c0, #ad8eb6);
...
.secondary-button {
  ...
  /* Effects */
  box-shadow: 0 4px 8px -1px rgba(0 0 0 / 0.64), 0 1px 4px 0 rgba(245, 192, 192, 0.056);
  user-select: none;
  cursor: pointer;
...
.card {
  ...
  /* Hover effects */
  transition: transform 0.25s cubic-bezier(0.25, 0.1, 0.25, 1), border 0.25s
...
.tooltip {
  ...
  box-shadow: 0 4px 4px rgba(1, 1, 27, 0.25), 0 0 54px #01011b,
...
```css
/* Subtle inset */
box-shadow: inset 0 0 0 1px hsla(0 0% 100% / 0.05), inset 0 1px 1px -1px hsla(0
        0% 100% / 0.05);
...
box-shadow: 0 0 0 1px rgba(245, 192, 192, 0.3), 0px 4px 50px 0px rgba(0, 0, 0, 0.52);
```
...
/* Pink theme glow */
[data-theme="pink"] {
  box-shadow: 0 0 54px #01011b, 0 0 50px rgba(245, 192, 192, 0.25);
}
```
...
/* Multi-property */
transition: transform 529.33ms var(--hover-transition-timing-function), border
    529.33ms var(--hover-transition-timing-function);
```
...
.hatched-pattern {
  background-image: repeating-linear-gradient(
    ...
    var(--hatch-color, rgba(236, 74, 74, 0.077)) calc(
        var(--hatch-size, 6px) - 1px
      ),
  ...
  <div class="hero-content">
    <div class="hero-text">
      ...
      <p class="text-xl hero-fade-in" style="animation-delay: 0.1s;">
        Fast, collaborative analytics with the simplicity of DuckDB and the
...
<div class="feature-card" data-category="notebooks">
  <div class="feature-card-content">
    ...
    <p class="text-base">
      Write SQL, Python, and R in collaborative notebooks with rich
      visualizations.
    </p>
